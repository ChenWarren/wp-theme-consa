...
/**
 * Cosa Theme Home Services section
 * 
 * @package consa
 */
?>
    ...
    <div class="container">
        ...
        <div class="services_section_2">
            <div class="row">
                <div class="col-lg-4">
                    <div class="icon_box">
                        <div class="icon_1"><img src="<?php echo get_template_directory_uri() . '/assets/images/icon-1.png'; ?>"></div>
                    </div>
                    ...
                    <div class="icon_box">
                        <div class="icon_1"><img src="<?php echo get_template_directory_uri() . '/assets/images/icon-4.png'; ?>"></div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="icon_box">
                        <div class="icon_1"><img src="<?php echo get_template_directory_uri() . '/assets/images/icon-2.png'; ?>"></div>
                    </div>
                    <h4 class="selection_text">Research and Analytics</h4>
                    <p class="ipsum_text">There are many variations of passages of Lorem Ipsum available, but the form, by injected humour, or randomised</p>
                    <div class="icon_box">
                        <div class="icon_1"><img src="<?php echo get_template_directory_uri() . '/assets/images/icon-5.png'; ?>"></div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="icon_box">
                        <div class="icon_1"><img src="<?php echo get_template_directory_uri() . '/assets/images/icon-3.png'; ?>"></div>
                    </div>
                    <h4 class="selection_text">Business Plans</h4>
                    <p class="ipsum_text">There are many variations of passages of Lorem Ipsum available, but the form, by injected humour, or randomised</p>
                    <div class="icon_box">
                        <div class="icon_1"><img src="<?php echo get_template_directory_uri() . '/assets/images/icon-6.png'; ?>"></div>
                    </div>
