...
/**
 * Cosa Theme Home Testimonial section
 * 
 * @package consa
 */
?>
                            ...
                            <div class="col-md-6">
                                <div class="testimonial_box">
                                    <div class="jonimo_taital_main">
                                        ...
                                        <div class="quick_icon"><img src="<?php echo get_template_directory_uri() . '/assets/images/quick-icon.png'; ?>"></div>
                                        <div class="quick_icon_1"><img src="<?php echo get_template_directory_uri() . '/assets/images/quick-icon1.png'; ?>"></div>
                                    </div>
